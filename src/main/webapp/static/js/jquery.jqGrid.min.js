        ...
        return this.each(function () {
            if (!this.grid) {
                        ...
                        if ($.isArray(d.p.data)) {
                            ...
                            if ($.each(d.p.colModel, function () {
                                    if (e = this.sorttype || "text", p = this.index || this.name, "date" === e || "datetime" === e ? (this.formatter && "string" == typeof
                                            ...
                                            newfmt: "",
                                            sfunc: this.sortfunc || null
                                        }, d.p.grouping)for (o = 0, n = q.groupField.length; n > o; o++)this.name === q.groupField[o] && (l[o] = k[p], m[o] = p);
                            ...
                            if (d.p.treeGrid && "adjacency" === d.p.treeGridModel && (n = 0, h = null), d.p.grouping)for (o = 0; n > o; o++)s.orderBy(m[o], q.groupOrder[o], l[o].stype, l[o].srcfmt);
                ...
                ra = null, e.hDiv = document.createElement("div"), e.hDiv.style.width = e.width - Ga + "px", e.hDiv.className = k(l, "headerDiv", !0, "ui-jqgrid-hdiv"), $(e.hDiv).append(Fa), $(Fa).append(Da), Da = null, Ea && $(e.hDiv).hide(), d.p.pager && ("string" == typeof
                    d.p.pager ? "#" !== d.p.pager.substr(0, 1) && (d.p.pager = "#" + d.p.pager) : d.p.pager = "#" + $(d.p.pager).attr("id"), $(d.p.pager).css({width: e.width + "px"}).addClass(k(l, "pagerBox", !0, "ui-jqgrid-pager")).appendTo(w), Ea && $(d.p.pager).hide(), U(d.p.pager, "")), d.p.cellEdit === !1 && d.p.hoverrows === !0 && $(d).on({
                ...
                $(d).before(e.hDiv).on({
                    ...
                    width: e.width - Ga + "px"
                }).scroll(e.scrollGrid), $("table:first", e.bDiv).css({width: d.p.tblwidth + "px"}), $.support.tbody || 2 === $("tbody", this).length && $("tbody:gt(0)", this).remove(), d.p.multikey && ($.jgrid.msie() ? $(e.bDiv).on("selectstart", function () {
                    return !1
            ...
            if (void
                ...
                if (m = a(p).attr("editable"), j.url = j.url || k.p.editurl, "1" === m) {
                    ...
                    if (a('td[role="gridcell"]', p).each(function (b) {
                        ...
                        try {
                            if (a.isFunction(k.p.validationCell)) k.p.validationCell.call(k, B, o[1], p.rowIndex, A); else {
                                var
                    ...
                    if (F = k.p.keyName === !1 ? G.id : k.p.keyName, r) {
                        if (r[G.oper] = G.editoper, void
                                0 === r[F] || "" === r[F]) r[F] = b; else if (p.id !== k.p.idPrefix + r[F]) {
                            var
                    ...
                    if ("clientArray" === j.url) {
                        ...
                        for (a(p).attr("editable", "0"), L = 0; L < k.p.savedRow.length; L++)if (String(k.p.savedRow[L].id) === String(H)) {
                            n = L;
                            break
                        }
        ...
        pivotSetup: function (c, d) {
            ...
            return this.each(function () {
                ...
                n(b, c, d, e, f) {
                    var
                        g;
                    if (a.isFunction(b)) g = b.call(this, c, d, e); else
                        switch (b) {
                            case"sum":
                ...
                o(b, c, d, e) {
                    ...
                    for (a.isArray(d) ? (l = d.length, s = d) : (l = 1, s[0] = d), h = [], i = [], h.root = 0, k = 0; l > k; k++) {
                        ...
                        for (g = 0; p > g; g++) {
                            if (m = "string" == typeof
                                    c[g].aggregator ? c[g].aggregator : "cust", null == d) j = a.trim(c[g].member) + "_" + m, u = j, s[0] = c[g].label || m + " " + a.trim(c[g].member); else {
                                u = d[k].replace(/\s+/g, "");
                                try {
                ...
                p(a) {
                    ...
                    for (d
                        ...
                        if ("object" != typeof
                            ...
                            if ("level" === d) {
                                if (void
                                        0 === M[a.level] && (M[a.level] = "", a.level > 0 && -1 === a.text.indexOf("_r_Totals") && (k[a.level - 1] = {
                                        useColSpanStyle: !1,
                                        groupHeaders: []
                ...
                for (var
                    ...
                    for (I
                        ...
                        if (0 === J) D.children && void
                            ...
                            for (L = null, s = 0; s < K.length; s++)if (K[s].text === I) {
                                L = K[s];
                                break
                            }
                ...
                if (l.colTotals)for (var
                                         Q = f.length; Q--;)for (s = t; s < e.length; s++)P = e[s].name, g[P] ? g[P] += parseFloat(f[Q][P] || 0) : g[P] = parseFloat(f[Q][P] || 0);
            ...
            return this.each(function () {
                ...
                f(b) {
                    ...
                    if (i = c.xDimension.length, d.sortname) {
                        for (f = d.sortorder ? d.sortorder : "asc", h = "text", e = 0; i > e; e++)if (c.xDimension[e].dataName === d.sortname) {
    ...
    a.jgrid = a.jgrid || {}, a.extend(a.jgrid, {
        ...
        xmlToZip: function (b, c) {
            ...
            a.each(c, function (c, n) {
                if (a.isPlainObject(n)) d = b.folder(c), j.xmlToZip(d, n); else {
                    if (l) {
        ...
        exportToCsv: function (b) {
            ...
            return this.each(function () {
                ...
                d(b, c) {
                    ...
                    a.each(k, function (a, b) {
                        var
                            c;
                        for (c = 0; i > c; c++)if (g.groupField[c] === b.name) {
                            h[c] = a;
                            break
                        }
                    });
                ...
                if (a.each(m, function (c, d) {
                    ...
                    }), b.includeLabels && (t = u.join(b.separator) + b.newLine), b.collen = u.length, j.p.grouping) p += d(k, b); else
                    for (; l > o;) {
            ...
            b = a.extend(!0, {
                ...
                var
                    d, e, f = this, g = a.jgrid.excelStrings, h = 0, i = a.parseXML(g["xl/worksheets/sheet1.xml"]), j = i.getElementsByTagName("sheetData")[0], k = {
                        _rels: {".rels": a.parseXML(g["_rels/.rels"])},
                        xl: {
                            _rels: {"workbook.xml.rels": a.parseXML(g["xl/_rels/workbook.xml.rels"])},
                ...
                var
                    p, q, r = function (c, d) {
                        ...
                        for (var
                            g
                            in
                            o.header[0])if (o.header[0].hasOwnProperty(g)) {
                            var
                            ...
                            if (null == n && (n = ""), d || (n = "" !== n ? a.jgrid.formatCell(n, o.map[e], c, l[o.map[e]], f) : n), o.width[e] = Math.max(o.width[e], Math.min(parseInt(n.length, 10), b.maxlength)), "number" == typeof
                                    n || n.match && a.trim(n).match(/^-?\d+(\.\d+)?$/) && !a.trim(n).match(/^0\d+/)) k = a.jgrid.makeNode(i, "c", {
                                attr: {
                                    t: "n",
                                    r: m
                                }, children: [a.jgrid.makeNode(i, "v", {text: n})]
                            }); else {
                                var
                                    r = n.replace ? a.jgrid.htmlEncode(n) : n;
                                k = a.jgrid.makeNode(i, "c", {
                                    attr: {t: "inlineStr", r: m},
                                    children: {row: a.jgrid.makeNode(i, "is", {children: {row: a.jgrid.makeNode(i, "t", {text: r})}})}
                                })
                            }
                            e++, q.appendChild(k)
                        }
                ...
                if (a("sheets sheet", k.xl["workbook.xml"]).attr("name", b.sheetName), b.includeGroupHeader && f.p.groupHeader && f.p.groupHeader.length) {
                    ...
                    for (m = 0; m < s.length; m++) {
                        ...
                        for (var
                            x
                            in
                            o.header[0])if (o.header[0].hasOwnProperty(x)) {
                            w[x] = "";
                            for (var
                                     y = 0; y < v.length; y++)if (v[y].startColumnName === x) {
                                w[x] = v[y].titleText;
                                var
                    ...
                    for (a("worksheet", i).append(B), m = 0; m < t.length; m++)B.appendChild(a.jgrid.makeNode(i, "mergeCell", {attr: t[m]}))
                }
                if (b.includeLabels && (r(o.header[0], !0), a("row c", i).attr("s", "2")), f.p.grouping) c(o.body); else
                    for (var
            ...
            return b = a.extend(!0, {
                ...
                c(b) {
                    ...
                    a.each(q, function (a, b) {
                        var
                            c;
                        for (c = 0; p > c; c++)if (g.groupField[c] === b.name) {
                            j[c] = a;
                            break
                        }
                    });
                ...
                if (b.includeLabels && i.push(p), h.p.grouping) c(l); else {
                    var
                        v;
                ...
                var
                    x = {
                        ...
                        content: [{style: "tableExample", widths: q, table: {headerRows: null != s ? 0 : 1, body: i}}],
                        styles: {
                            tableHeader: {
                                bold: !0,
                                fontSize: 11,
