...
public class MailUtils {
    ...
    public static String myEmailAccount = "347127519@qq.com";
    public static String myEmailPassword = "xierroxcdmdgbgfh";
...
//    public static String receiveMailAccount = "xiejava@qq.com";
    ...
    public static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail,String content) throws Exception {
        ...
        // 2. From: 发件人
        message.setFrom(new InternetAddress(sendMail,"挂号系统专用", "UTF-8"));

        // 3. To: 收件人（可以增加多个收件人、抄送、密送）
        message.setRecipient(MimeMessage.RecipientType.TO, new InternetAddress(receiveMail));

        // 4. Subject: 邮件主题
        message.setSubject("挂号系统重置密码邮件", "UTF-8");
